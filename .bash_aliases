...
onelineps1() {
    ...
    PS1="\[\e]0;${debian_chroot:+($debian_chroot)}\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}\[\033[0;31m\]\u\[\033[00m\]@\[\033[0;34m\]\h\[\033[00m\]:\[\033[0;32m\]$path\[\033[00m\]\[\033[0;35m\]$git\[\033[00m\]\\\$ "
}
